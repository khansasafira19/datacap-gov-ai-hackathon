...
$this->registerJsFile('datacap/library/js/fi-featured-poverty.js', ['depends' => [\yii\web\JqueryAsset::className()]]);
?>
<section id="poverty" class="team section bg-light" data-aos="fade-up" data-aos-delay="100">
    <!-- Section Title -->
    <div class="container-fluid section-title" data-aos="fade-up">
        <h2>Featured Topic 1</h2>
        <div><span>Dashboard Visualisasi Kemiskinan Indonesia</span></div>
                ...
                <div class="row">
                    <div class="col-lg-8 mb-2">
                        <div class="card"> <!-- Reduced padding -->
                            <!-- Chart Container -->
                            <div id="d1-chart1" style="height:500px;"></div>
                    ...
                    <div class="col-lg-4 mb-2">
                        <div class="card"> <!-- Reduced padding -->
                            <!-- Chart Container -->
                            <div id="d1-chart2" style="height:500px;"></div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-4 mb-2">
                        <div class="card"> <!-- Reduced padding -->
                            <!-- Chart Container -->
                            <div id="d1-chart3" style="height:300px;"></div>
                        </div>
                    </div>
                    <div class="col-lg-4 mb-2">
                        <div class="card"> <!-- Reduced padding -->
                            <!-- Chart Container -->
                            <div id="d1-chart4" style="height:300px;"></div>
                        </div>
                    </div>
                    <div class="col-lg-4 mb-2">
                        <div class="card"> <!-- Reduced padding -->
                            <!-- Chart Container -->
                            <div id="d1-chart5" style="height:300px;"></div>
                        </div>
                    </div>
                </div>
            </div>
