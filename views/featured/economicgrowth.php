...
$this->registerJsFile('datacap/library/js/fi-featured-economicgrowth.js', ['depends' => [\yii\web\JqueryAsset::className()]]);
?>
<section id="economicgrowth" class="team section bg-light" data-aos="fade-up" data-aos-delay="100">
    <!-- Section Title -->
    <div class="container-fluid section-title" data-aos="fade-up">
        <h2>Featured Topic 3</h2>
                ...
                <div class="row">
                    <div class="col-lg-8 mb-2">
                        <div class="card"> <!-- Reduced padding -->
                            <!-- Chart Container -->
                            <div id="d3-chart1" style="height:500px;"></div>
                    ...
                    <div class="col-lg-4 mb-2">
                        <div class="card"> <!-- Reduced padding -->
                            <!-- Chart Container -->
                            <div id="d3-chart2" style="height:500px;"></div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-4 mb-2">
                        <div class="card"> <!-- Reduced padding -->
                            <!-- Chart Container -->
                            <div id="d3-chart3" style="height:300px;"></div>
                        </div>
                    </div>
                    <div class="col-lg-4 mb-2">
                        <div class="card"> <!-- Reduced padding -->
                            <!-- Chart Container -->
                            <div id="d3-chart4" style="height:300px;"></div>
                        </div>
                    </div>
                    <div class="col-lg-4 mb-2">
                        <div class="card"> <!-- Reduced padding -->
                            <!-- Chart Container -->
                            <div id="d3-chart5" style="height:300px;"></div>
                        </div>
                    </div>
                </div>
            </div>
